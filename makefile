...
SHELL_OBJS   = bin/shell.o bin/pcs_io.o bin/shell_args.o bin/dir.o bin/hashtable.o bin/rc4.o bin/daemon.o bin/logger.o bin/sqlite3.o bin/utils.o
...
bin/utils.o: test/utils.c test/utils.h
	$(CC) -o $@ -c $(PCS_CCFLAGS) test/utils.c
test/version.h:
	bash ver.sh
